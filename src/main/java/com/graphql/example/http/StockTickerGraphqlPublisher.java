...
import com.graphql.example.http.data.TestPublisher;
...
public class StockTickerGraphqlPublisher {
    ...
    private final static TestPublisher TEST_PUBLISHER = new TestPublisher();
    ...
    private DataFetcher test() {
        return environment -> TEST_PUBLISHER.getPublisher();
    }
